...
function yo(self) {
    ...
    var options_url = 'https://reyohoho.space/cache'
    // options.url
    ...
    options.button = (options.button)
        ? options.button
        : 'hdrezka: {Q} {T}, collaps: {Q} {T}, videocdn: {Q} {T}, hdvb: {Q} {T}, bazon: {Q} {T}, ustore: {Q} {T}, alloha: {Q} {T}, kodik: {Q} {T}, iframe: {Q} {T}';
    if (options.button) {
        ...
        function (players) {
            ...
            if (j < 1) {
                ...
                setTimeout(function () {
                    ...
                    location.replace('https://reyohoho.space');
                }, 2000);
            }
            else if (j > 1) {
                for (var i = 0; i < searchItems.length; i++)
