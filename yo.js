...
function yo(self) {
    ...
    options.player = ((options.title && /трейлер|trailer|teaser/i.test(options.title)) || t)
        ...
        : options.player
            ? options.player
            : 'collaps,hdvb,bazon,ustore,alloha,videocdn,iframe,kodik,pleer,apivb,voidboost';
    ...
    options.button = (options.button)
        ? options.button
        : 'videocdn: {Q} {T}, hdvb: {Q} {T}, bazon: {Q} {T}, ustore: {Q} {T}, alloha: {Q} {T}, kodik: {Q} {T}, iframe: {Q} {T}, collaps: {Q} {T}, apivb: {Q} {T}, voidboost: {Q} {T}';
    if (options.button) {
